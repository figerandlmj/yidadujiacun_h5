...
var kBaseRoadUrl = kBaseFrontendUrl + 'route/index';			/*度假路线首页**/
...
function ZMAlert(message, successCallback) {
	...
	html+='	<div style="background:url(images/tip.png) no-repeat center;width:188px;height:80px;background-size:188px 80px;"></div>';
	html+='	<p style="height:90px;background:#fff;width:100%;text-align:center;line-height:30px;font-size:.14rem;font-weight:bold;">'+message+'</p>';
...
function circleMask(){
	...
	$("body").append('<div id="circle_mask" style="background: #000;opacity: 0.37;position: absolute;width: 100%;height: 100%;top: 0;z-index: 99999998;"><img src="images/circle.gif" id="circle_img" width="32" height="32" style="position:absolute;display:block;z-index: 99999999;"></div>');
